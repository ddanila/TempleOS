...
def main():
    ...
    if args.test:
        ...
        if (size != runtime_layout['image_bytes'] or span != ((size+7)&~7)+16 or
                ...
                code_discard_address != address+runtime_layout['code_discard_offset']):
        ...
        result['file_runtime'] = dict(version=7, image_address=file_address, image_bytes=file_size,
