...
def compiler_runtime_layout(module):
    ...
    if version_offset+4 > 32+size or struct.unpack_from('<I', module, version_offset)[0] != 27:
...
def main():
    ...
    if args.test:
        ...
        if len(runtime) != 1 or len(runtime[0]) != 41:
