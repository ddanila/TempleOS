...
def compiler_runtime_layout(module):
    ...
    return dict(image_bytes=size+8, string_offset=8+exports['I386LexStringChunk'][1],
                ...
                code_span_offset=8+exports['I386FrontendCodeSpan'][1],
...
def main():
    ...
    if args.test:
        ...
        if len(runtime) != 1 or len(runtime[0]) != 55:
        ...
        result['compiler_runtime'] = dict(module='CompilerRuntime', version=50, image_address=address,
