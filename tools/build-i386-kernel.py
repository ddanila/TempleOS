...
def compiler_runtime_layout(module):
    ...
    if version_offset+4 > 32+size or struct.unpack_from('<I', module, version_offset)[0] != 54:
...
def main():
    ...
    if args.test:
        ...
        result['compiler_runtime'] = dict(module='CompilerRuntime', version=54, image_address=address,
