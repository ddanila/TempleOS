...
def compiler_runtime_layout(module):
    ...
    if version_offset+4 > 32+size or struct.unpack_from('<I', module, version_offset)[0] != 18:
...
def compiler_probe_layout(module):
    ...
    for name in ('Main', 'ProbeTokens', 'ProbeIdent', 'ProbeDefine', 'ProbeConditional', 'ProbeIncludes', 'ProbeIncludePush', 'ProbeDiskIncludes', 'ProbeCompilerUnwind'):
    ...
    if args.test:
        ...
        if (size != runtime_layout['image_bytes'] or span != ((size+7)&~7)+16 or
                ...
                any(value != address+runtime_layout[key] for value,key in (
                    ...
                    (code_append_address,'code_append_offset'), (code_retire_address,'code_retire_offset')))):
        ...
        result['file_runtime'] = dict(version=9, image_address=file_address, image_bytes=file_size,
