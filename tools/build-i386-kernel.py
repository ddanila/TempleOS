    ...
    if args.test:
        ...
        if (size != runtime_layout['image_bytes'] or span != ((size+7)&~7)+16 or
                ...
                any(value != address+runtime_layout[key] for value,key in (
                    ...
                    (code_append_address,'code_append_offset')))):
        ...
        result['file_runtime'] = dict(version=8, image_address=file_address, image_bytes=file_size,
