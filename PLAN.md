...
checks 709 packaged files and embedded DolDoc record lengths. Two native x86-64 rebuild/reboot generations also pass; persistence, audio, and
...
including real slave PIC delivery and RTC configuration restoration. Next, bring up the production
